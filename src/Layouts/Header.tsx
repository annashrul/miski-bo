      ...
      <div className="container flex items-center justify-between h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
        ...
        <ul className="flex items-center flex-shrink-0 space-x-6">
          ...
          <li className="relative">
             ...
             */}
            <button
              className="flex flex-row items-center space-x-2 w-full px-4 py-2 mt-2 text-sm font-semibold text-left bg-transparent text-gray-700 dark:text-gray-400  md:w-auto md:inline md:mt-0 md:ml-4 focus:bg-gray-800 focus:outline-none focus:shadow-outline"
              onClick={() => {
