...
const Widget: React.FC<iWidget> = ({ title, icon, routes }) => {
  ...
  const non =
    'px-2 py-1 transition-colors duration-150 font-semibold text-gray-800 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100';
  ...
  return (
    <li className="relative px-6 py-3" key={title}>
      ...
      <button
        className="inline-flex items-center justify-between w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-200 dark:hover:text-gray-200 focus:outline-none"
